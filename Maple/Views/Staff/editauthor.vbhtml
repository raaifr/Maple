...
@Using (Html.BeginForm("updateauthor", "Staff", Nothing, FormMethod.Post))
    ...
    @<div Class="form-group p-2">
        <div Class="row" style="float:right;">
            <input type="button" value="Cancel Edits" style="min-width:3rem;" Class="btn btn-outline-danger" onclick="location.href='@Url.Action("viewauthor", "Staff")'" />
