...
@Code
    ...
    If Not TempData(Constants.IDENT_REQ_SUCCESS) = Nothing And TempData(Constants.IDENT_REQ_SUCCESS) = True Then
        banner = True
        bText = "Your payment has been received. You can now proceed to login. Enjoy!"
        TempData(Constants.IDENT_REQ_SUCCESS) = Nothing
    ElseIf Not TempData(Constants.IDENT_REQ_FAIL_ONE) = Nothing And TempData(Constants.IDENT_REQ_FAIL_ONE) = True Then
        banner = True
...
<body>
    ...
    @Using (Html.BeginForm("Login", "Auth", Nothing, FormMethod.Post, New With {.class = "form-signin mb-4 w3"}))
        ...
        @<div>
            ...
            <p class="mt-4">Not a member? @Html.ActionLink("Register", "Register", "Auth") with us!</p>
